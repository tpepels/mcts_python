...
def identify_experiments_to_cancel(aggregated_rows, top_n):
    # Filter out rows with "N/A" in win rate or CI, and ensure more than 30 games were completed
    filtered_rows = [row for row in aggregated_rows if row[-3] != "N/A" and row[-2] != "N/A" and int(row[-1]) > 30]
